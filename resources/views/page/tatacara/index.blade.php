...
@section('content')
    <div class="container bg-white py-4 px-4 rounded shadow">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                <img src="{{ asset('img/Edit/daftarr.png') }}" class="img-fluid rounded border" style="width: 100%; border: 3px solid #2196f3; border-radius: 10px;" alt="Daftar"> 
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                <img src="{{ asset('img/Edit/tambahh.png') }}" class="img-fluid rounded border" style="width: 100%; border: 3px solid #2196f3; border-radius: 10px;" alt="Berkas Aktif"> 
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                <img src="{{ asset('img/Edit/filterr.png') }}" class="img-fluid rounded border" style="width: 100%; border: 3px solid #2196f3; border-radius: 10px;" alt="Berkas Aktif"> 
            </div>
            
            <div class="col-md-12 mt-2">
                <p style="font-size: 20px;">Untuk mencari atau memfilter data, 
                    silakan isi kolom 'Isi Berkas', 'Tahun Berkas', 'Kategori', dan 'Klasifikasi' sesuai dengan data yang ingin dicari. 
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4">
                <img src="{{ asset('img/Edit/musnah.png') }}" width="180" height="620" class="img-fluid rounded border" style="border: 3px solid #2196f3; border-radius: 10px;" alt="Side Bar"> 
            </div>
            <div class="col-md-8">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4">
                <img src="{{ asset('img/Edit/permanen.png') }}" width="180" height="620" class="img-fluid rounded border" style="border: 3px solid #2196f3; border-radius: 10px;" alt="Side Bar"> 
            </div>
            <div class="col-md-8">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                <img src="{{ asset('img/Data/inaktif.jpg') }}" class="img-fluid rounded border" style="width: 100%; border: 3px solid #2196f3; border-radius: 10px;" alt="Berkas Inaktif"> 
            </div>
